...
$programCheck=$conn->prepare("SELECT 1 FROM students WHERE college=? AND program=? LIMIT 1");$programCheck->bind_param('ss',$session['college'],$program);$programCheck->execute();if(!$programCheck->get_result()->fetch_row())json_response(['success'=>false,'message'=>'Select a program assigned to your college.'],422);
try{

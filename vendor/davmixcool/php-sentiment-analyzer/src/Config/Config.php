...
class Config
{
    ...
    const NEGATE = [
        ...
        // Filipino negations
        "hindi", "di", "dili", "wala", "ni", "huwag", "kulang", "imposible", "bawal", "hindi pa",
        "hindi na", "hindi rin", "hindi", "di", "wala", "ni isa", "ni walang", "huwag", "wag", 
        "kakulangan", "walang", "hindi pa", "di pa", "bihira", "halos wala", "konti", "hindi talaga", 
        "wala talaga", "ni isa man", "ayaw", "huwag nang", "di kailanman",  "hindi rin", "wala rin", 
        "huwag kang", "huwag mo", "wala man", "ni isa man lang", "hindi na", "huwag na", "di na", 
        "hindi naman", "wala naman", "huwag naman", "ni isa man kahit", "hindi pa rin", "hindi pa man", 
        "walang kahit ano", "walang sino man", "hindi rin naman", "huwag mong", "hindi dapat", 
        "hindi puwede", "di puwede", "di dapat", "walang puwede", "hindi kaya", "di kaya", "naman", "namang"
    ];

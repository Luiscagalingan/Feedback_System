...
if ($type === 'dean') {
    ...
    $office=trim((string)($input['office']??''));$service=trim((string)($input['service']??''));if($office===''||$service==='')json_response(['success'=>false,'message'=>'Assigned office and service description are required.'],422);
